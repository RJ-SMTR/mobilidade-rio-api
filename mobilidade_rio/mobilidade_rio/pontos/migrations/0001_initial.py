# Generated by Django 3.1.14 on 2022-11-13 04:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agency_timezone', models.CharField(blank=True, max_length=500, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monday', models.CharField(blank=True, max_length=500, null=True)),
                ('tuesday', models.CharField(blank=True, max_length=500, null=True)),
                ('wednesday', models.CharField(blank=True, max_length=500, null=True)),
                ('thursday', models.CharField(blank=True, max_length=500, null=True)),
                ('friday', models.CharField(blank=True, max_length=500, null=True)),
                ('saturday', models.CharField(blank=True, max_length=500, null=True)),
                ('sunday', models.CharField(blank=True, max_length=500, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_id', models.CharField(blank=True, max_length=500)),
                ('date', models.CharField(blank=True, max_length=500, null=True)),
                ('exception_type', models.CharField(blank=True, max_length=500, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Frequencies',
