# Generated by Django 3.1.14 on 2022-12-07 01:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('continuous_pickup', models.IntegerField(blank=True, choices=[(0, 'boarding with continuous stops'), (1, 'no boarding'), (2, 'schedule boarding'), (3, 'make an appointment with the driver')], default=1, null=True)),
                ('continuous_drop_off', models.IntegerField(blank=True, choices=[(0, 'boarding with continuous stops'), (1, 'no boarding'), (2, 'schedule boarding'), (3, 'make an appointment with the driver')], default=1, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Shapes',
