# Generated by Django 3.1.14 on 2022-12-06 23:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('route_type', models.IntegerField(choices=[(0, 'VLT'), (1, 'Trem e metrô municipais'), (2, 'Trem e metrô intermunicipais'), (3, 'Ônibus'), (4, 'Barcas'), (5, 'Bonde'), (6, 'Teleférico'), (7, 'Funicular'), (11, 'Ônibus elétrico'), (12, 'Monotrilho')])),
                ...
                ('continuous_pickup', models.IntegerField(blank=True, choices=[(0, 'embarque com paradas contínuas'), (1, 'nenhum embarque com paradas contínuas'), (2, 'agendar embarque com paradas contínuas'), (3, 'combinar agendamento com o motorista')], default=1, null=True)),
                ('continuous_drop_off', models.IntegerField(blank=True, choices=[(0, 'embarque com paradas contínuas'), (1, 'nenhum embarque com paradas contínuas'), (2, 'agendar embarque com paradas contínuas'), (3, 'combinar agendamento com o motorista')], default=1, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Shapes',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wheelchair_accessible', models.IntegerField(blank=True, choices=[(0, 'sem informação'), (1, 'acessível'), (2, 'informação não disponível')], null=True)),
                ('bikes_allowed', models.IntegerField(blank=True, max_length=500, null=True)),
